...
private:
        ...
        Node* add(std::string s, Node *next_p);
        void addToFront(std::string s);
        int whereToAdd(std::string s);
        void addAt(std::string s, int i);

        void removeFromFront();
        void remove_helper(std::string word);
        WordFreq get_helper(int index);
